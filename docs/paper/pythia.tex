...
\affiliation{
  \institution{\textsuperscript{$\ast$}Greek Research and Technology Network,\\
  \textsuperscript{$\dagger$}National Technical University of Athens}
}
\email{{lgian, degleri, dimitro}@noc.grnet.gr,
panag@cs.ntua.gr}
